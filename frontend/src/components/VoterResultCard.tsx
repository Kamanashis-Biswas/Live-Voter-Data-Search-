                  ...
                  {voters.map((voter) => (
                    ...
                    >
                      ...
                      <td className="p-4 text-xs text-slate-700">
                        ...
                        <p className="text-slate-400 text-[10px]">{voter.address.district}</p>
                      </td>
                ...
                <div className="p-4 bg-slate-50 flex flex-col gap-2">
                  <div className="text-xs text-slate-600 bg-white p-3 rounded-xl border border-slate-200">
                    ...
                    <div className="pl-4 text-slate-500 space-y-0.5">
                      <p>গ্রাম: {selectedVoter.address.village}, ডাকঘর: {selectedVoter.address.postOffice}</p>
                      <p>উপজেলা: {selectedVoter.address.upazila}, জেলা: {selectedVoter.address.district}</p>
                    </div>
                  </div>
                    ...
                    <table className="w-full text-left text-xs border-collapse">
                      ...
                      <tbody className="divide-y divide-slate-400">
                        ...
                        <tr className="bg-amber-100/90 ring-2 ring-amber-500 text-[11px] text-slate-900 font-medium">
                          ...
                          <td className="p-2 border-r border-slate-900 font-semibold">{voterForPdf.village}, {voterForPdf.address.postOffice}</td>
